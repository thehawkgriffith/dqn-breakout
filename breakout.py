...
class DQN:
    ...
    def __init__(self, K, conv_layer_sizes, hidden_layer_sizes, max_exp=500000, min_exp=50000, batch_sz=32):
        ...
        self.X = tf.placeholder(tf.float32, shape=(None, 4, 80, 80), name='X')
...
def downsample_image(A):
    B = A[31:195]
    B = B.mean(axis=2)
    B = imresize(B, size=(80, 80), interp='nearest')
    return B
